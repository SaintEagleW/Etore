        ...
        <div class="row">
            ...
            <div class="col-md-4 left-col">
                <div class="profile-sidebar">
                    ...
                    <a href="http://localhost:8000/user/editProfile" class="btn btn-light btn-outline-secondary sidebar-btn">Edit Profile</a>
                    <a href="http://localhost:8000/user/changePassword" class="btn btn-light btn-outline-secondary sidebar-btn">Change Password</a>
                    <a class="btn btn-light btn-outline-secondary sidebar-btn" type="submit" id="submit">Log Out</a>
                </div>
            </div>
    ...
    <script>
        ...
        const renderOrderDetail = (orderDetail) => {
            ...
            for (i = 0; i < orderDetail.items.length; i++) {
                ...
                // let name = $('<label>').addClass('order-itemName').text(`${orderDetail.orderLists[i].productName} ${orderDetail.orderLists[i].productSku}`).appendTo(title);
